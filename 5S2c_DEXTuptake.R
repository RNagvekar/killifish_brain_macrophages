...
norm_by_animal_young_scaledata_df <- by_animal_young_scaledata_df %>%
  ...
  mutate(across(starts_with("percent") | starts_with("mean"), 
                ...
                .names = "norm_{.col}")) %>%
  select(oScarlet_status, sex, date, starts_with("norm_"))
...
# Plot for normalized mean DEXT of oScarletLOW vs. oScarletHIGH (males)
# Save at 200W x 300H
ggplot(data = subset(norm_by_animal_young_scaledata_df, norm_by_animal_young_scaledata_df$sex == "M"), aes(x = oScarlet_status, y = norm_mean_DEXT)) +
  ylim(c(0, 5)) +
  geom_point(shape = 15, size = 2, position = position_jitter(width = 0.1, height = 0), color = "#0b6623", alpha = 0.5) +
  geom_line(linetype = "blank") +
  ...
  geom_errorbar(data = subset(summary_stats_norm_by_animal_young_scaledata_df,
                              summary_stats_norm_by_animal_young_scaledata_df$sex == "M"),
                aes(x = oScarlet_status, y = norm_mean_DEXT_mean,
  ...
  #ggtitle("norm mean DEXT of oScarletLOW vs. oScarletHIGH (males)") +
  theme_minimal() +
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
  theme(plot.margin = unit(c(1, 1, 1, 1), "cm"),
        panel.border = element_rect(color = "black", fill = NA, size = 0.5),
...
norm_mean_DEXT_oScarletLOWvsoScarletHIGH_wilcox_result_M <- wilcox.test(norm_by_animal_young_scaledata_df$norm_mean_DEXT[norm_by_animal_young_scaledata_df$sex == "M" & norm_by_animal_young_scaledata_df$oScarlet_status == "oScarletLOW"],
                                                                        norm_by_animal_young_scaledata_df$norm_mean_DEXT[norm_by_animal_young_scaledata_df$sex == "M" & norm_by_animal_young_scaledata_df$oScarlet_status == "oScarletHIGH"],
                                                                        paired = TRUE)
norm_mean_DEXT_oScarletLOWvsoScarletHIGH_pval_M <- norm_mean_DEXT_oScarletLOWvsoScarletHIGH_wilcox_result_M$p.value

# Plot for normalized percent DEXT+ of oScarletLOW vs. oScarletHIGH (males)
# Save at 200W x 300H
ggplot(data = subset(norm_by_animal_young_scaledata_df, norm_by_animal_young_scaledata_df$sex == "M"), aes(x = oScarlet_status, y = `norm_percent_DEXT+`)) +
  ylim(c(0, 45)) +
  geom_point(shape = 15, size = 2, position = position_jitter(width = 0.1, height = 0), color = "#0b6623", alpha = 0.5) +
  geom_line(linetype = "blank") +
  geom_segment(data = subset(summary_stats_norm_by_animal_young_scaledata_df,
  ...
  geom_errorbar(data = subset(summary_stats_norm_by_animal_young_scaledata_df,
                              summary_stats_norm_by_animal_young_scaledata_df$sex == "M"),
                aes(x = oScarlet_status, y = `norm_percent_DEXT+_mean`,
                    ymin = `norm_percent_DEXT+_mean` - `norm_percent_DEXT+_se`,
                    ymax = `norm_percent_DEXT+_mean` + `norm_percent_DEXT+_se`),
                width = 0.1, color = "black", size = 1, alpha = 0.5) +
  #ggtitle("norm percent DEXT+ of oScarletLOW vs. oScarletHIGH (males)") +
  theme_minimal() +
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
  theme(plot.margin = unit(c(1, 1, 1, 1), "cm"),
        panel.border = element_rect(color = "black", fill = NA, size = 0.5),
...
# Wilcoxon test (paired)
`norm_percent_DEXT+_oScarletLOWvsoScarletHIGH_wilcox_result_M` <- wilcox.test(norm_by_animal_young_scaledata_df$`norm_percent_DEXT+`[norm_by_animal_young_scaledata_df$sex == "M" & norm_by_animal_young_scaledata_df$oScarlet_status == "oScarletLOW"],
                                                                              norm_by_animal_young_scaledata_df$`norm_percent_DEXT+`[norm_by_animal_young_scaledata_df$sex == "M" & norm_by_animal_young_scaledata_df$oScarlet_status == "oScarletHIGH"],
                                                                              paired = TRUE)
`norm_percent_DEXT+_oScarletLOWvsoScarletHIGH_pval_M` <- `norm_percent_DEXT+_oScarletLOWvsoScarletHIGH_wilcox_result_M`$p.value

# Plot for normalized mean DEXT of DEXT+ of oScarletLOW vs. oScarletHIGH (males)
# Save at 200W x 300H
ggplot(data = subset(norm_by_animal_young_scaledata_df, norm_by_animal_young_scaledata_df$sex == "M"), aes(x = oScarlet_status, y = `norm_mean_DEXT_of_DEXT+`)) +
  ylim(c(0, 1.5)) +
  geom_point(shape = 15, size = 2, position = position_jitter(width = 0.1, height = 0), color = "#0b6623", alpha = 0.5) +
  geom_line(linetype = "blank") +
  geom_segment(data = subset(summary_stats_norm_by_animal_young_scaledata_df,
...
# Wilcoxon test (paired)
`norm_mean_DEXT_of_DEXT+_oScarletLOWvsoScarletHIGH_wilcox_result_M` <- wilcox.test(norm_by_animal_young_scaledata_df$`norm_mean_DEXT_of_DEXT+`[norm_by_animal_young_scaledata_df$sex == "M" & norm_by_animal_young_scaledata_df$oScarlet_status == "oScarletLOW"],
                                                                                   norm_by_animal_young_scaledata_df$`norm_mean_DEXT_of_DEXT+`[norm_by_animal_young_scaledata_df$sex == "M" & norm_by_animal_young_scaledata_df$oScarlet_status == "oScarletHIGH"],
                                                                                   paired = TRUE)
`norm_mean_DEXT_of_DEXT+_oScarletLOWvsoScarletHIGH_pval_M` <- `norm_mean_DEXT_of_DEXT+_oScarletLOWvsoScarletHIGH_wilcox_result_M`$p.value
...
setwd("C:/Users/Rahul/Dropbox/Rahul shared folder/Paper_F31_Rahul/Paper/V2/sourcedata/5S2c")
write.csv(by_animal_and_oScarlet_status_scaledata_df, "SourceDataTable11.csv")