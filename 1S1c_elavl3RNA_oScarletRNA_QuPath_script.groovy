//This script will detect all DAPI+ cells as well as subcellular spots in Channels 2 and 4.
...
//Detect subcellular spots in Channels 2 and 4
runPlugin('qupath.imagej.detect.cells.SubcellularDetection', '{"detection[Channel 1]":-1.0,"detection[Channel 2]":7000,"detection[Channel 3]":-1.0,"detection[Channel 4]":7000,"doSmoothing":false,"splitByIntensity":false,"splitByShape":false,"spotSizeMicrons":0.2,"minSpotSizeMicrons":0.1,"maxSpotSizeMicrons":1.0,"includeClusters":false}')
