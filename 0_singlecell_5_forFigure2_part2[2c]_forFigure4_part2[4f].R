...
# Fig 2c
# PCA (mouse markers) for Helena ZT12 microglia, BAM, MDM
# Save at 500W x 500H
...
# N.B. For the creation of SR_WL_myeloid object please refer to script 0_singlecell_9_forFigure4_part3[4g-i_4S1c-d].R
...
# Fig 4f
# PCA (mouse markers) for WL_myeloid
# Save at 500W x 500H
