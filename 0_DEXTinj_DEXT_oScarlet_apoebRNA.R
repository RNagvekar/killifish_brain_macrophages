...
setwd("C:/Users/Rahul/Dropbox/Rahul shared folder/Paper_F31_Rahul/Paper/V2/sourcedata/0_DEXTinj/")
write.csv(by_animal_and_oScarlet_status_excludeapoebRNAhighdensity_excludeS4DEXT_measurements_DEXT_oScarlet_apoebRNA_df, "SourceDataTable2.csv")
