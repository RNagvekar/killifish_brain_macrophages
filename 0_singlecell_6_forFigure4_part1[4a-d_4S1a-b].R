...
# Fig 4a
# UMAP by orig.ident
# OSR = light red, YSR = red
# Save at 500W x 500H
DimPlot(YSR_OSR_20251202, reduction = "umap", group.by = "orig.ident", cols = c("#ffc1be", "red")) +
...
VlnPlot(YSR_OSR_20251202, features = "cytoplasmictranslation_sum_GO_expr", group.by = "orig.ident", cols = c("#ff7f7f", "#ffc1be"), pt.size = 0) +
...
VlnPlot(YSR_OSR_20251202, features = "endocytosis_sum_GO_expr", group.by = "orig.ident", cols = c("#ff7f7f", "#ffc1be"), pt.size = 0) +
  geom_point(size = 0.5, alpha = 0.4, color = "gray", position = position_jitter(w = 0.35, h = 0)) +
  geom_violin(aes(fill = YSR_OSR_20251202$orig.ident),
              alpha = 0.8,
              trim = TRUE,
...
VlnPlot(YSR_OSR_20251202, features = "PRendocytosis_sum_GO_expr", group.by = "orig.ident", cols = c("#ff7f7f", "#ffc1be"), pt.size = 0) +
  geom_point(size = 0.5, alpha = 0.4, color = "gray", position = position_jitter(w = 0.35, h = 0)) +
  geom_violin(aes(fill = YSR_OSR_20251202$orig.ident),
              alpha = 0.8,
              trim = TRUE,
...
VlnPlot(YSR_OSR_20251202, features = "lysosome_sum_GO_expr", group.by = "orig.ident", cols = c("#ff7f7f", "#ffc1be"), pt.size = 0) +
  geom_point(size = 0.5, alpha = 0.4, color = "gray", position = position_jitter(w = 0.35, h = 0)) +
  geom_violin(aes(fill = YSR_OSR_20251202$orig.ident),
              alpha = 0.8,
              trim = TRUE,
...
VlnPlot(YSR_OSR_20251202, features = "PRlysosome_sum_GO_expr", group.by = "orig.ident", cols = c("#ff7f7f", "#ffc1be"), pt.size = 0) +
  geom_point(size = 0.5, alpha = 0.4, color = "gray", position = position_jitter(w = 0.35, h = 0)) +
  geom_violin(aes(fill = YSR_OSR_20251202$orig.ident),
              alpha = 0.8,
              trim = TRUE,
...
VlnPlot(YSR_OSR_20251202, features = "vacuolaracidification_sum_GO_expr", group.by = "orig.ident", cols = c("#ff7f7f", "#ffc1be"), pt.size = 0) +
  geom_point(size = 0.5, alpha = 0.4, color = "gray", position = position_jitter(w = 0.35, h = 0)) +
  geom_violin(aes(fill = YSR_OSR_20251202$orig.ident),
              alpha = 0.8,
              trim = TRUE,
...
VlnPlot(YSR_OSR_20251202, features = "inflammation_sum_GO_expr", group.by = "orig.ident", cols = c("#ff7f7f", "#ffc1be"), pt.size = 0) +
  geom_point(size = 0.5, alpha = 0.4, color = "gray", position = position_jitter(w = 0.35, h = 0)) +
  geom_violin(aes(fill = YSR_OSR_20251202$orig.ident),
              alpha = 0.8,
              trim = TRUE,
...
VlnPlot(YSR_OSR_20251202, features = "PRinflammation_sum_GO_expr", group.by = "orig.ident", cols = c("#ff7f7f", "#ffc1be"), pt.size = 0) +
  geom_point(size = 0.5, alpha = 0.4, color = "gray", position = position_jitter(w = 0.35, h = 0)) +
  geom_violin(aes(fill = YSR_OSR_20251202$orig.ident),
              alpha = 0.8,
              trim = TRUE,
