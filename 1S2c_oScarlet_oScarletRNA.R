...
setwd("C:/Users/Rahul/Dropbox/Rahul shared folder/Paper_F31_Rahul/Paper/V2/sourcedata/1S2c/1S2c_QuPath_proj/")

# Read .csv
measurements_oScarlet_oScarletRNA_df <- read.csv("1S2c_oScarlet_oScarletRNA_measurements.csv")
...
# Fig 1S2c - oScarlet vs. oScarlet RNA
