...
scaledata_df$oScarlet_status <- case_when(
  ...
  scaledata_df$oScarlet > 1000 ~ "oScarletHIGH",
...
setwd("C:/Users/Rahul/Dropbox/Rahul shared folder/Paper_F31_Rahul/Paper/V2/sourcedata/0_DEXTuptake")
write.csv(by_animal_and_oScarlet_status_scaledata_df, "SourceDataTable10.csv")