...
# Feature plot
FeaturePlot(SR_WL_myeloid_20251202, "csf1r", cols = c("yellow", "purple"))
...
# Figure 4f
# UMAP by orig.ident
# SR = light red, WL = grey
# Save at 500W x 500H
DimPlot(SR_WL_myeloid_20251202, reduction = "umap", group.by = "orig.ident", cols = c("#f37e8a", "grey")) +
...
# SRmyeloid = light red, WLmyeloid = grey
# Save at 300W x 500H
...
VlnPlot(SR_WL_myeloid_20251202, features = "cytoplasmictranslation_sum_GO_expr", group.by = "orig.ident", cols = c("#ffa7a5", "grey"), pt.size = 0) +
...
VlnPlot(SR_WL_myeloid_20251202, features = "endocytosis_sum_GO_expr", group.by = "orig.ident", cols = c("#ffa7a5", "grey"), pt.size = 0) +
  geom_point(size = 0.5, alpha = 0.4, color = "gray", position = position_jitter(w = 0.35, h = 0)) +
  geom_violin(aes(fill = SR_WL_myeloid_20251202$orig.ident),
              alpha = 0.8,
              trim = TRUE,
...
VlnPlot(SR_WL_myeloid_20251202, features = "PRendocytosis_sum_GO_expr", group.by = "orig.ident", cols = c("#ffa7a5", "grey"), pt.size = 0) +
  geom_point(size = 0.5, alpha = 0.4, color = "gray", position = position_jitter(w = 0.35, h = 0)) +
  geom_violin(aes(fill = SR_WL_myeloid_20251202$orig.ident),
              alpha = 0.8,
              trim = TRUE,
...
VlnPlot(SR_WL_myeloid_20251202, features = "lysosome_sum_GO_expr", group.by = "orig.ident", cols = c("#ffa7a5", "grey"), pt.size = 0) +
  geom_point(size = 0.5, alpha = 0.4, color = "gray", position = position_jitter(w = 0.35, h = 0)) +
  geom_violin(aes(fill = SR_WL_myeloid_20251202$orig.ident),
              alpha = 0.8,
              trim = TRUE,
...
VlnPlot(SR_WL_myeloid_20251202, features = "PRlysosome_sum_GO_expr", group.by = "orig.ident", cols = c("#ffa7a5", "grey"), pt.size = 0) +
  geom_point(size = 0.5, alpha = 0.4, color = "gray", position = position_jitter(w = 0.35, h = 0)) +
  geom_violin(aes(fill = SR_WL_myeloid_20251202$orig.ident),
              alpha = 0.8,
              trim = TRUE,
...
VlnPlot(SR_WL_myeloid_20251202, features = "vacuolaracidification_sum_GO_expr", group.by = "orig.ident", cols = c("#ffa7a5", "grey"), pt.size = 0) +
  geom_point(size = 0.5, alpha = 0.4, color = "gray", position = position_jitter(w = 0.35, h = 0)) +
  geom_violin(aes(fill = SR_WL_myeloid_20251202$orig.ident),
              alpha = 0.8,
              trim = TRUE,
