...
ggplot(data = subset(norm_by_animal_oScarletHIGH_scaledata_df, norm_by_animal_oScarletHIGH_scaledata_df$sex == "M"), aes(x = age, y = norm_mean_oScarlet, color = age)) +
  ...
  geom_line(linetype = "blank") +
  scale_color_manual(values = c("#ee2400", "#6200ea")) +
...
setwd("C:/Users/Rahul/Dropbox/Rahul shared folder/Paper_F31_Rahul/Paper/V2/sourcedata/0_OVAuptake")
write.csv(by_animal_and_oScarlet_status_scaledata_df, "SourceDataTable7.csv")