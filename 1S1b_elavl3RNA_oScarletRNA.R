...
setwd("C:/Users/Rahul/Dropbox/Rahul shared folder/Paper_F31_Rahul/Paper/V2/sourcedata/1S1b/1S1b_QuPath_proj/")

# Read .csv
measurements_elavl3RNA_oScarletRNA_df <- read.csv("elavl3RNA_oScarletRNA_measurements.csv")
