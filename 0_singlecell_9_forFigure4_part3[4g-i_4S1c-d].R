...
# N.B. For Fig 4f please refer to script 0_singlecell_5_forFigure2_part2[2c]_forFigure4_part2[4f].R

# Fig 4g
# UMAP by orig.ident
# SR = purple, WL = grey
# Save at 500W x 500H
DimPlot(SR_WL_myeloid_20251202, reduction = "umap", group.by = "orig.ident", cols = c("purple", "grey")) +
